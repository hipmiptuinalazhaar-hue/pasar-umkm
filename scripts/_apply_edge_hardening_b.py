...
p2_path = Path(".github/workflows/ui-p2-commerce-validate.yml")
p2 = p2_path.read_text(encoding="utf-8")
p2 = p2.replace("js/profile-saved.js?v=2.1", "js/profile-saved.js?v=2.2")
p2 = p2.replace("js/commerce-experience-v2.js?v=2.0", "js/commerce-experience-v2.js?v=2.1")
p2_path.write_text(p2, encoding="utf-8")

p6_path = Path(".github/workflows/ui-p6-polish-performance-validate.yml")
p6 = p6_path.read_text(encoding="utf-8")
p6 = p6.replace("js/profile-saved.js?v=2.1", "js/profile-saved.js?v=2.2")
p6 = p6.replace("js/commerce-experience-v2.js?v=2.0", "js/commerce-experience-v2.js?v=2.1")
old_allowed = "allowed='^(index\\.html|js/account-resilience\\.js|js/profile-saved\\.js|js/profile-edit\\.js|css/profile-edit\\.css|css/rating-form-v3\\.css|\\.github/workflows/p2-validate\\.yml|\\.github/workflows/ui-p2-commerce-validate\\.yml|\\.github/workflows/ui-p3-social-validate\\.yml|\\.github/workflows/ui-p5-tablet-desktop-validate\\.yml|\\.github/workflows/ui-p6-polish-performance-validate\\.yml)$'"
new_allowed = "allowed='^(index\\.html|js/account-resilience\\.js|js/profile-saved\\.js|js/commerce-experience-v2\\.js|js/profile-edit\\.js|src/functionality-api\\.js|scripts/validate-edge-hardening-b\\.mjs|docs/ERROR_EDGE_HARDENING_B\\.md|css/profile-edit\\.css|css/rating-form-v3\\.css|\\.github/workflows/edge-hardening-b-validate\\.yml|\\.github/workflows/p2-validate\\.yml|\\.github/workflows/ui-p2-commerce-validate\\.yml|\\.github/workflows/ui-p3-social-validate\\.yml|\\.github/workflows/ui-p5-tablet-desktop-validate\\.yml|\\.github/workflows/ui-p6-polish-performance-validate\\.yml)$'"
p6 = replace_once(p6, old_allowed, new_allowed, "P6 guarded maintenance scope")
p6_path.write_text(p6, encoding="utf-8")

Path(".github/workflows/_apply-edge-hardening-b.yml").unlink()
Path("scripts/_apply_edge_hardening_b.py").unlink()
