...
requireMatch('register-verify-route', v2, '/api/auth/register/verify');
requireMatch('register-resend-route', v2, '/api/auth/register/resend');
requireMatch('forgot-route', v2, '/api/auth/password/forgot');
requireMatch('password-verify-route', v2, '/api/auth/password/verify');
requireMatch('password-reset-route', v2, '/api/auth/password/reset');
...
requireMatch('registration-pending-bcrypt', api, "gen_salt('bf', 12)");
