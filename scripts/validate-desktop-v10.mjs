...
['hero split uses official marketplace branding',desktop.includes('.desktop-hero-brand-panel')&&desktop.includes('.desktop-hero-brand-logo')&&desktop.includes('minmax(360px,.92fr)')],
['hero branding has no seller/product feed hydration',desktopJs.includes('/assets/logo.webp?v=2.0')&&!desktopJs.includes('is-product-post')&&!desktopJs.includes('.ig-product-name')&&!desktopJs.includes('.ig-product-price')],
