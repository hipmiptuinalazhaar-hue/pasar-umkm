...
(() => {
  ...
  loadScript('script[data-profile-title-center-module="true"]', 'js/profile-title-center.js?v=1.0', 'profileTitleCenterModule');
  ...
  loadScript('script[data-rating-core="true"]', 'js/rating-core.js?v=1.0', 'ratingCore');
